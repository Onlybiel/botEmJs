module.exports = {
  config: {
    nome: 'beijo',                                                   // NOTA: Coloque o nome do comando SEMPRE em letras minúsculas!
    aliases: ['beijar', 'kiss'],                               // Alternativas para o comando, para você poder usar o comando com vários nomes diferentes.
